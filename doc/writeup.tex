...
as normal. The profiler will write its reports (updated every second)
to the developer console. If you would like the profiler to print less
frequently, change the setInterval call on line 42 of profiling.ts
and recompile using the typescript compiler. 
\end{itemize}
