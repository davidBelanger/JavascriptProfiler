...
\begin{enumerate}
\item Run the original code (by calling doTest());
\item Modify the code to be instrumented for profiling, and call
  doTest().
...
change the output of javascript code. It does not ensure that the
...
test suite, since it calls eval
